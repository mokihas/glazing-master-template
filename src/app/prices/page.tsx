  ...
  return (
    <div className="wrap" style={{ paddingBlock: "80px", minHeight: "60vh" }}>
      ...
      <div style={{ marginBottom: "2rem", position: "relative", height: "300px", background: "#f3f4f6", borderRadius: "12px", overflow: "hidden" }}>
        <img src={siteConfig.heroImage} alt="Placeholder for Prices" style={{ width: "100%", height: "100%", objectFit: "cover" }} />
      </div>

      <div style={{ fontSize: "1.1rem", lineHeight: 1.6 }}>
        <h2>Our Approach to Prices</h2>
        <p>
          [Extensive Placeholder Content for Prices]. This section can be populated with your specific service descriptions, terms, and detailed processes. Our team ensures that every aspect of your project is handled with the utmost professional care.
        </p>
        <p>
