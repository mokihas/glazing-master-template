export const siteConfig = {
  ...
  legalBusinessName: "[LEGAL BUSINESS NAME] Ltd.",
  tagline: "Professional Glass & Glazing Services",
  ...
  description: "Reliable glass installation, replacement and glazing solutions for homes, businesses and commercial properties across [CITY] and surrounding areas. We provide professional, high-quality workmanship.",
