  ...
  services: [
    {
      ...
      slug: "windows",
      shortDescription: "[Short Description for Windows]",
      longDescription: "[Long Description for Windows]",
      image: "/images/service-placeholder.svg",
      applications: ["[Application 1]", "[Application 2]"],
    },
    {
      id: "doors",
      name: "Front and Back Doors",
      slug: "doors",
      shortDescription: "[Short Description for Doors]",
      longDescription: "[Long Description for Doors]",
      image: "/images/service-placeholder.svg",
      applications: ["[Application 1]", "[Application 2]"],
    },
    {
      id: "bifold",
      name: "Bi-folds and Sliders",
      slug: "bifold",
      shortDescription: "[Short Description for Bi-folds]",
      longDescription: "[Long Description for Bi-folds]",
      image: "/images/service-placeholder.svg",
      applications: ["[Application 1]", "[Application 2]"],
    },
    {
      ...
      name: "Sliding Sash",
      slug: "sash",
      shortDescription: "[Short Description for Sliding Sash]",
      longDescription: "[Long Description for Sliding Sash]",
      image: "/images/service-placeholder.svg",
      applications: ["[Application 1]", "[Application 2]"],
    },
    {
      ...
      name: "Conservatories",
      slug: "conservatories",
      shortDescription: "[Short Description for Conservatories]",
      longDescription: "[Long Description for Conservatories]",
      image: "/images/service-placeholder.svg",
      applications: ["[Application 1]", "[Application 2]"],
    },
    {
      id: "repairs",
      name: "Repairs and Misted Units",
      slug: "repairs",
      shortDescription: "[Short Description for Repairs]",
      longDescription: "[Long Description for Repairs]",
      image: "/images/service-placeholder.svg",
      applications: ["[Application 1]", "[Application 2]"],
    },
    {
      id: "whole-house",
      name: "Whole House Replacements",
      slug: "whole-house",
      shortDescription: "[Short Description for Whole House]",
      longDescription: "[Long Description for Whole House]",
      image: "/images/service-placeholder.svg",
      applications: ["[Application 1]", "[Application 2]"],
    }
  ],
